...
public class ConstantesSQL {
	public final static String SQL_OBTENER_DETALLES_INSTRUMENTO = "select i.nombre_instrumento,i.id,i.descripcion,i.gamma,i.precio,i.tipo,i.categoria_id_categoria,m.nombre_marca from tabla_instrumentos as i, marca as m where i.id = :id and i.marca_id = m.id";
	...
	public static final String SQL_OBTENER_LISTADO_INSTRUMENTOS_INCLUYENDO_NOMBRE_COMIENZO = "select i.nombre_instrumento,i.id,i.descripcion,i.gamma,i.precio,i.tipo,i.categoria_id_categoria,m.nombre_marca,i.estado,c.id_categoria,c.nombre from tabla_instrumentos as i, marca as m, categoria as c where i.marca_id = m.id and c.id_categoria =i.categoria_id_categoria and i.nombre_instrumento like :nombre order by i.id asc limit :comienzo, 12";
